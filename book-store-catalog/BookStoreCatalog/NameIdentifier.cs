...
namespace BookStoreCatalog
{
    ...
    public class NameIdentifier
    {
        ...
        /// <exception cref="ArgumentNullException">Thrown when the isniCode argument is null.</exception>
        /// <exception cref="ArgumentException">Thrown when the isniCode argument is invalid.</exception>
        public NameIdentifier(string isniCode)
        {
            if (isniCode == null)
            {
                throw new ArgumentNullException(nameof(isniCode), "ISNI code cannot be null.");
            }
