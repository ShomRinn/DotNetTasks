...
namespace FormattingStrings
{
    public static class FormatStrings
    {
        ...
        {
            return string.Format(NumberFormatInfo.InvariantInfo, "{0} {2} {1} {3} {4}", str2, number1, number2, number3, str1);
        }
        ...
        {
            return string.Format(NumberFormatInfo.InvariantInfo, "{1},{3},{0:X4},{2},{4}", number1, number2, number3, str1, str2);
        }
        ...
        {
            return string.Format(NumberFormatInfo.InvariantInfo, "{{ \"parameter\": \"{2}\", \"code\": {{ \"type\": \"{1}\", \"label\": \"{3:X4}\" }}, \"value\": {{ \"data\": \"{4:F}\", \"units\": \"{0}\" }}}}", str1, str2, str3, number1, number2);
        }
