...
namespace BinarySearch
{
    public static class ArrayExtension
    {
        ...
        public static int BinarySearch<T>(this T[]? array, T value) => BinarySearch(array, value, Comparer<T>.Default);
        ...
        public static int BinarySearch<T>(this T[]? array, T value, IComparer<T>? comparer)
        {
            ...
            if (!array.GetType().GetElementType()!.IsInstanceOfType(value))
            {
                throw new ArgumentException("value is of a type that is not compatible with the elements of array.", nameof(value));
            }
            ...
            while (left <= right)
            {
                ...
                int compare = comparer!.Compare(array[mid], value);
