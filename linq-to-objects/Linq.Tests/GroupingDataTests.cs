...
namespace Linq.Tests
{
    ...
    public class GroupingDataTests
    {
        ...
        public void GroupByPropertyTest()
        {
            ...
            var expected = new[]
            {
                new[] { "abacus", "apple" }, new[] { "blueberry", "banana" }, new[] { "chimpanzee", "cheese" }
            };
        ...
        public void GroupingTest()
        {
            var expected = new[]
            {
                (0, new[] { 5, 0 }), (4, new[] { 4, 9 }), (1, new[] { 1, 6 }), (3, new[] { 3, 8 }),
                (2, new[] { 7, 2 })
            };
        ...
        public void GroupByCustomComparerTest()
        {
            ...
            var expected = new[]
            {
                new[] { "from   ", " form  " }, new[] { "  mane", "name   ", "mean" },
                new[] { " salt", "  last   " }, new[] { " earn ", " near " },
            };
