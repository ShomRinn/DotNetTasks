...
namespace Linq
{
    ...
    /// <see cref="IEnumerable{TSource}"/>, <see cref="IEnumerable{TSource}"/>
    ...
    public static class SetOperations
    {
        ...
        public static IEnumerable<char> UnionOfQueryResults()
        {
            ...
            return products.Select(product => product.ProductName[0]).Union(customers.Select(customer => customer.CompanyName[0]));
        }
        ...
        public static IEnumerable<char> IntersectQueryResults()
        {
            ...
            return products.Select(product => product.ProductName[0]).Intersect(customers.Select(customer => customer.CompanyName[0]));
        }
        ...
        public static IEnumerable<char> DifferenceOfQueries()
        {
            ...
            return products.Select(product => product.ProductName[0]).Except(customers.Select(customer => customer.CompanyName[0]));
        }
    }
}
