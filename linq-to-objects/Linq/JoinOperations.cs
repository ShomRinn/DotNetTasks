...
namespace Linq
{
    ...
    public static class JoinOperations
    {
        ...
        public static IEnumerable<(string category, string productName)> JoinQuery()
        {
            ...
            return categories.Join(products, category => category, product => product.Category, (category, product) => (category, product.ProductName));
        }
        ...
        public static IEnumerable<(string category, IEnumerable<Product> productsName)> GroupJoinQuery()
        {
            ...
            return categories.GroupJoin(products, category => category, product => product.Category, (category, productList) => (category, productList));
        }
        ...
        public static IEnumerable<(string category, string productName)> LeftOuterJoin()
        {
            ...
            return from category in categories
                   ...
                   select (category, productName: subProduct != null ? subProduct.ProductName : "(No products)");
        }
    }
}
