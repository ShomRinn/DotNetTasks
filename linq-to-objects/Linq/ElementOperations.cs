...
namespace Linq
{
    ...
    {
        /// <summary>
        /// Finds the first element wich category contains a 'Product'.
        /// </summary>
        ...
        public static Product FirstElement()
        {
            ...
            return products.First(p => p.Category.Contains("Product", StringComparison.InvariantCulture));
        }
        ...
        public static string FirstMatchingElement()
        {
            ...
            return strings.First(s => s.StartsWith("o", StringComparison.InvariantCulture));
        }
        ...
        public static int ElementAtPosition()
        {
            ...
            return numbers.Where(number => number > 5).ElementAt(1);
        }
        ...
        public static string LastMatchingElement()
        {
            ...
            return strings.Last(s => s.Contains('o', StringComparison.InvariantCulture));
        }
        ...
        public static string SingleMoreThanOneMatchingElement()
        {
            ...
            return strings.Single(s => s.Contains('o', StringComparison.InvariantCulture));
        }
        ...
        public static string MaybeSingleMatchingElement()
        {
            ...
            return strings.Any(s => s.Contains('o', StringComparison.InvariantCulture)) ? null : strings.FirstOrDefault(s => s.Contains('o', StringComparison.InvariantCulture));
        }
    }
}
