        ...
        private static IEnumerable<TestCaseData> FilterTestCases
        {
            get
            {
                yield return new TestCaseData(
                        new ContainsDigitPredicateAdapter(new ContainsDigitValidator { Digit = 0 }),
                        new[] { 2212332, 1405644, -1236674 })
                    .Returns(new[] { 1405644 });
                yield return new TestCaseData(
                        new ContainsDigitPredicateAdapter(new ContainsDigitValidator { Digit = 7 }),
                ...
                yield return new TestCaseData(
                        new ContainsDigitPredicateAdapter(new ContainsDigitValidator { Digit = 2 }),
